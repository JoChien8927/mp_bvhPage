...
class OutlinePass extends Pass {
  constructor(
    ...
    this.hoveredObjects = hoveredObjects ? hoveredObjects : [];
    this.selectedObjects = selectedObjects ? selectedObjects : [];
    this.visibleEdgeColor = hoverColor;
    this.hiddenEdgeColor = hoverColor;
    this.angleColor = angleColor;

    // this.edgeGlow = 0.0;
    this.usePatternTexture = false;
    this.edgeThickness = 1.0;
    this.edgeStrength = size;
  ...
  getJointsSelected() {
    const selection = {
      originJoint: this.selectedObjects[0],
      directionJoint1: this.selectedObjects[1],
      directionJoint2: this.selectedObjects[2],
    };
  ...
  render(renderer, writeBuffer, readBuffer, deltaTime, maskActive) {
    if (this.selectedObjects.length > 0) {
      ...
      renderer.setClearColor(0xe8a628);
